...
#import "BLPagerController.h"

@class BLTabPagerController;

@protocol BLTabPagerControllerDelegate <BLPagerControllerDelegate>

@optional
// configre collectionview cell
- (void)pagerController:(BLTabPagerController *)pagerController configreCell:(UICollectionViewCell *)cell forItemTitle:(NSString *)title atIndexPath:(NSIndexPath *)indexPath;
...
- (void)pagerController:(BLTabPagerController *)pagerController transitionFromeCell:(UICollectionViewCell *)fromCell toCell:(UICollectionViewCell *)toCell animated:(BOOL)animated;

// transition frome cell to cell with progress
- (void)pagerController:(BLTabPagerController *)pagerController transitionFromeCell:(UICollectionViewCell *)fromCell toCell:(UICollectionViewCell *)toCell progress:(CGFloat)progress;

@end

typedef NS_ENUM(NSUInteger, BLPagerBarStyle) {
    BLPagerBarStyleNoneView,
    BLPagerBarStyleProgressView,
    BLPagerBarStyleProgressBounceView,
    BLPagerBarStyleCoverView
};

@interface BLTabPagerController : BLPagerController

#pragma clang diagnostic push
#pragma clang diagnostic ignored"-Wobjc-property-synthesis"
@property (nonatomic, weak) id<BLTabPagerControllerDelegate> delegate;
...
@property (nonatomic, assign) BLPagerBarStyle barStyle; // you can set or ovrride barStyle
