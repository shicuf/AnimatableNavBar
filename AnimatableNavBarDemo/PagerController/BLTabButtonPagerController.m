...
- (void)configureTabButtonPropertys
{
    ...
    self.barStyle = BLPagerBarStyleProgressView;
    ...
    [self registerCellClass:[BLTabTitleCell class] isContainXib:NO];
}
...
- (void)setBarStyle:(BLPagerBarStyle)barStyle
{
    ...
    switch (barStyle) {
        case BLPagerBarStyleProgressView:
            self.progressWidth = 0;
            self.progressHeight = kUnderLineViewHeight;
            self.progressEdging = 3;
            break;
        case BLPagerBarStyleProgressBounceView:
            self.progressHeight = kUnderLineViewHeight;
            self.progressWidth = 30;
            break;
        case BLPagerBarStyleCoverView:
            self.progressWidth = 0;
    ...
    if (barStyle == BLPagerBarStyleCoverView) {
...
- (void)transitionFromCell:(UICollectionViewCell<BLTabTitleCellProtocol> *)fromCell toCell:(UICollectionViewCell<BLTabTitleCellProtocol> *)toCell
{
    if (fromCell) {
...
- (void)transitionFromCell:(UICollectionViewCell<BLTabTitleCellProtocol> *)fromCell toCell:(UICollectionViewCell<BLTabTitleCellProtocol> *)toCell progress:(CGFloat)progress
{
...
- (void)pagerController:(BLTabPagerController *)pagerController configreCell:(BLTabTitleCell *)cell forItemTitle:(NSString *)title atIndexPath:(NSIndexPath *)indexPath
{
    BLTabTitleCell *titleCell = (BLTabTitleCell *)cell;
...
- (void)pagerController:(BLTabPagerController *)pagerController transitionFromeCell:(UICollectionViewCell<BLTabTitleCellProtocol> *)fromCell toCell:(UICollectionViewCell<BLTabTitleCellProtocol> *)toCell animated:(BOOL)animated
{
    if (animated) {
        [UIView animateWithDuration:self.animateDuration animations:^{
            [self transitionFromCell:(BLTabTitleCell *)fromCell toCell:(BLTabTitleCell *)toCell];
        }];
    }else{
...
- (void)pagerController:(BLTabPagerController *)pagerController transitionFromeCell:(UICollectionViewCell<BLTabTitleCellProtocol> *)fromCell toCell:(UICollectionViewCell<BLTabTitleCellProtocol> *)toCell progress:(CGFloat)progress
{
